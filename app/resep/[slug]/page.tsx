...
export default async function DetailResepPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            <div className="w-full h-56 bg-gradient-to-br from-[#F4A261]/25 to-[#F6C1C7]/25 rounded-3xl flex items-center justify-center mb-6">
            ...
            <p className="text-[#7A7A7A] leading-relaxed mb-8">{recipe!.description}</p>
